...
# Memory bank definitions from DiiA Specification, DALI Part 251 -
...
ContentFormatID = NumericValue(
    "ContentFormatID",
    locations=(
        MemoryLocation(bank=BANK_1, address=0x11, default=0x00,
                       type_=MemoryType.NVM_RW_P),
        MemoryLocation(bank=BANK_1, address=0x12, default=0x03,
                       type_=MemoryType.NVM_RW_P),
    )
)
...
YearOfManufacture = NumericValue(
    "YearOfManufacture",
    locations=(MemoryLocation(bank=BANK_1, address=0x13, default=0xff,
                              type_=MemoryType.NVM_RW_P),)
)
...
WeekOfManufacture = NumericValue(
    "WeekOfManufacture",
    locations=(MemoryLocation(bank=BANK_1, address=0x14, default=0xff,
                              type_=MemoryType.NVM_RW_P),)
)
...
InputPowerNominal = NumericValue(
    "InputPowerNominal",
    unit='W',
    locations=MemoryRange(bank=BANK_1, start=0x15, end=0x16, default=0xff,
                          type_=MemoryType.NVM_RW_P).locations
)
...
InputPowerMinimumDim = NumericValue(
    ...
    unit='W',
    locations=MemoryRange(bank=BANK_1, start=0x17, end=0x18, default=0xff,
                          type_=MemoryType.NVM_RW_P).locations
)
...
MainsVoltageMinimum = NumericValue(
    "MainsVoltageMinimum",
    unit='V',
    locations=MemoryRange(bank=BANK_1, start=0x19, end=0x1a, default=0xff,
                          type_=MemoryType.NVM_RW_P).locations
)
...
MainsVoltageMaximum = NumericValue(
    "MainsVoltageMaximum",
    unit='V',
    locations=MemoryRange(bank=BANK_1, start=0x1b, end=0x1c, default=0xff,
                          type_=MemoryType.NVM_RW_P).locations
)
...
LightOutputNominal = NumericValue(
    "LightOutputNominal",
    unit='Lm',
    locations=MemoryRange(bank=BANK_1, start=0x1d, end=0x1f, default=0xff,
                          type_=MemoryType.NVM_RW_P).locations
)
...
CRI = NumericValue(
    "CRI",
    locations=(MemoryLocation(bank=BANK_1, address=0x20, default=0xff,
                              type_=MemoryType.NVM_RW_P),)
)
...
CCT = NumericValue(
    "CCT",
    unit='K',
    locations=MemoryRange(bank=BANK_1, start=0x21, end=0x22, default=0xff,
                          type_=MemoryType.NVM_RW_P).locations
)
...
LightDistributionType = __LightDistributionTypeValue(
    ...
    locations=(MemoryLocation(bank=BANK_1, address=0x23, default=0xff,
                              type_=MemoryType.NVM_RW_P),)
)

"""Luminaire color

24 ascii character string, first char at 0x24

Null terminated if shorter than defined length.
"""
LuminaireColor = StringValue(
    "LuminaireColor",
    locations=MemoryRange(bank=BANK_1, start=0x24, end=0x3b, default=0x00,
                          type_=MemoryType.NVM_RW_P).locations
)

"""Luminaire identification

60 ascii character string, first char at 0x3C

Null terminated if shorter than defined length.
"""
LuminaireIdentification = StringValue(
    "LuminaireIdentification",
    locations=MemoryRange(bank=BANK_1, start=0x3c, end=0x77, default=0x00,
                          type_=MemoryType.NVM_RW_P).locations
)

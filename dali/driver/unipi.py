...
if __name__ == '__main__':
    ...
    """
    from dali.gear.general import Off, DAPC, Up, OnAndStepUp, IdentifyDevice, RecallMaxLevel
    from dali.gear.general import QueryStatus, QueryDeviceType, QueryActualLevel, AddToGroup
